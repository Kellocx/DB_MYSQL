...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt->bind_param("iisiii", $id_cliente, $id_destinazione, $dataprenotazione, $acconto, $numero_persone, $assicurazione);
    if ($stmt->execute()) {
...
<?php if (!empty($messaggio)): ?>
    ...
    <div class="modal fade" id="esitoModal" tabindex="-1" aria-labelledby="esitoModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-<?= $tipoMessaggio ?>">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            var myModal = new bootstrap.Modal(document.getElementById("esitoModal"));
            myModal.show();
        });
    </script>
<?php endif; ?>
